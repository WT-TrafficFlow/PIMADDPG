...
parser.add_argument("--config", default='configurations/SUMO_SIM.conf', type=str,
...
def train_main(_mean=None, _std=None):
    ...
    for epoch in range(start_epoch, epochs):
        ...
        params_filename = os.path.join(params_path, 'sumo_sim')
