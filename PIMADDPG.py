...
for i in range(300):
            ...
            if (step + 1) % 60 == 0 and step != 59: # 60预测了120步的状态，因此需要119步时候的状态
                ...
                agent3_memory.add(np.vstack(
                    ...
                    [result_3[index], result_1[index], result_2[index], result_4[index], result_1_vsl[index],
                     result_2_vsl[index], result_3 - vsl[index], result_4_vsl[index]]), False)
    ...
    tripinfo_file_path = f"output_bothMADDPG_control/MADDPG_control_tripinfo_{0}.xml"
...
np.save(f"output_bothMADDPG_control/reward_list.npy",reward_list)
# ---------- 存储总行程时间\主路行程时间\总延误时间\主路延误时间 ----------------
MADDPG_control_travel_time_epi = np.array(travel_time_epi)
np.save(f'output_bothMADDPG_control/MADDPG_control_travel_time_epi.npy',MADDPG_control_travel_time_epi)
MADDPG_control_main_travel_time_epi = np.array(main_travel_time_epi)
np.save(f'output_bothMADDPG_control/MADDPG_control_main_travel_time_epi.npy',MADDPG_control_main_travel_time_epi)
MADDPG_control_travelloss_time_epi = np.array(travelloss_time)
np.save(f'output_bothMADDPG_control/MADDPG_control_travelloss_time_epi.npy',MADDPG_control_travelloss_time_epi)
MADDPG_control_main_travelloss_time_epi = np.array(main_travelloss_time)
np.save(f'output_bothMADDPG_control/MADDPG_control_main_travelloss_time_epi.npy',MADDPG_control_main_travelloss_time_epi)
# # --------- 存储智能体的动作集合 ------------
...
np.save(f'output_bothMADDPG_control/rm1_action_list.npy',rm1_action_list)
np.save(f'output_bothMADDPG_control/rm2_action_list.npy',rm2_action_list)
np.save(f'output_bothMADDPG_control/rm3_action_list.npy',rm3_action_list)
np.save(f'output_bothMADDPG_control/rm4_action_list.npy',rm4_action_list)
# # --------- 存储智能体的动作集合 ------------
...
np.save(f'output_bothMADDPG_control/vsl1_action_list.npy',vsl1_action_list)
np.save(f'output_bothMADDPG_control/vsl2_action_list.npy',vsl2_action_list)
np.save(f'output_bothMADDPG_control/vsl3_action_list.npy',vsl3_action_list)
np.save(f'output_bothMADDPG_control/vsl4_action_list.npy',vsl4_action_list)
# # ------- 存储匝道排队长度 -------------------
MADDPG_control_avg_quene_lenth1 = np.array(rm1_avg_quene_lenth)
MADDPG_control_avg_quene_lenth2 = np.array(rm2_avg_quene_lenth)
MADDPG_control_avg_quene_lenth3 = np.array(rm3_avg_quene_lenth)
MADDPG_control_avg_quene_lenth4 = np.array(rm4_avg_quene_lenth)
np.save(f'output_bothMADDPG_control/MADDPG_control_avg_quene_lenth1.npy',MADDPG_control_avg_quene_lenth1)
np.save(f'output_bothMADDPG_control/MADDPG_control_avg_quene_lenth2.npy',MADDPG_control_avg_quene_lenth2)
np.save(f'output_bothMADDPG_control/MADDPG_control_avg_quene_lenth3.npy',MADDPG_control_avg_quene_lenth3)
np.save(f'output_bothMADDPG_control/MADDPG_control_avg_quene_lenth4.npy',MADDPG_control_avg_quene_lenth4)
